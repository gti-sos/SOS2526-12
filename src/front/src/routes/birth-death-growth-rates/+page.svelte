<script>
	...
	async function añadirRegistro() {
		...
		if (res.ok || res.status === 201) {
			...
			mostrarMensaje(
				'Faltan campos obligatorios: código de país, nombre del país y año son necesarios.',
				'error'
			);
...
<main>
	...
	<div class="formulario">
		<input type="text" placeholder="Buscar por país" bind:value={buscarPais} />
		<input type="number" placeholder="Buscar por año" bind:value={buscarAnio} />
